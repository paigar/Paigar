...
- Un "profesional" les hizo la web hace dos años con una plantilla de 60€
- Les cobró entre 1.500€ y 5.000€ por la "personalización"
- Desde entonces nadie ha actualizado WordPress, ni los plugins, ni el tema
- La web ha sido hackeada, o es lenta, o tiene plugins incompatibles
- El "profesional" ya no está disponible, o cobra por cada cambio menor
...
- **Entiende el stack completo** — desde el servidor hasta el CSS que renderiza el navegador
- **Escribe código** — puede crear un tema desde cero, modificar funcionalidad, depurar errores
- **Toma decisiones técnicas informadas** — elige WordPress cuando es la herramienta adecuada, no porque sea la única que conoce
- **Piensa en el mantenimiento** — sabe que una web no se "termina" el día de la entrega
- **Sabe de rendimiento, accesibilidad y seguridad** — cosas que ningún plugin soluciona automáticamente
- **Es honesto** — dice al cliente lo que necesita oír, no lo que quiere oír
