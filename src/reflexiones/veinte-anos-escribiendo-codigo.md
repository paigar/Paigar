...
- **Tablas para layout** — la única forma de hacer columnas antes de que existiera CSS decente
- **Flash** — el rey de la web interactiva durante una década, enterrado por Steve Jobs en una carta abierta
- **jQuery** — revolucionario en su momento, innecesario hoy
- **Frameworks CSS** como Bootstrap y Foundation — útiles cuando CSS era limitado, redundantes ahora
- **Gulp, Grunt, Webpack** — cada uno prometía ser la herramienta definitiva de build
- **Frameworks JS** que aparecen y desaparecen cada dos años con sus ecosistemas incompatibles
...
- **La simplicidad** — el código más fácil de mantener es el que no existe. Cada línea que escribes es una línea que alguien tendrá que entender, depurar o borrar en el futuro.
- **La independencia** — construir sin depender de frameworks que desaparecen cada dos años. HTML, CSS y JavaScript vanilla no van a ningún sitio.
- **El detalle** — un buen interlineado importa más que una animación espectacular. La tipografía correcta transmite más profesionalidad que cualquier efecto parallax.
- **La honestidad** — no hay nada malo en admitir que HTML y CSS son suficientes para la mayoría de webs. No todo necesita ser una aplicación.
- **La responsabilidad** — cada kilobyte que envías al navegador tiene un coste: en ancho de banda, en batería, en CO₂. Ser un buen desarrollador también es ser consciente de ese impacto.
