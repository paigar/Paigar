...
No sabe que:
- Su web tiene un rendimiento deficiente porque carga 30 plugins innecesarios
- Los colores que ha elegido no pasan el contraste mínimo de accesibilidad
- Su formulario de contacto es vulnerable a spam porque no tiene protección
- Su web no es responsive de verdad — se ve bien en su móvil, pero se rompe en otros
- Las imágenes que ha subido pesan 5MB cada una y tardan segundos en cargar en conexiones lentas
- Su sitio es vulnerable a ataques porque no ha actualizado nada en meses
...
- Entender HTML semántico — no solo qué etiquetas existen, sino por qué importa usarlas correctamente
- Dominar CSS — no solo copiar snippets, sino entender la cascada, la especificidad, el box model, el layout
- Conocer JavaScript — el lenguaje real, no solo la API de un framework
- Comprender el rendimiento — qué afecta a los tiempos de carga y cómo medirlo
- Aplicar accesibilidad — WCAG no es una sugerencia, y los lectores de pantalla existen
- Gestionar la seguridad — HTTPS, headers, sanitización de inputs, actualizaciones
- Pensar en el mantenimiento — el código que escribes hoy alguien lo mantendrá mañana
