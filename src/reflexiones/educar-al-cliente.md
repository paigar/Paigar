...
- "Quiero poner música de fondo en la web" → hay que explicar por qué eso perjudica la experiencia
- "Quiero que se vea exactamente igual en todos los navegadores" → hay que explicar que eso no es realista y que la consistencia razonable es el objetivo
- "¿Podemos copiar el diseño de esta otra web?" → hay que explicar que eso puede tener implicaciones legales y que un diseño propio siempre es mejor inversión
- "No necesitamos HTTPS, es solo una web informativa" → hay que explicar que HTTPS es obligatorio hoy en día
